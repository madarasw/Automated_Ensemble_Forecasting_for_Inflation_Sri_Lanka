"""Tab17_HCPI_EM14 - Headline Consumer Price Index, EM14 (Wasserstein) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab17_HCPI_EM14", loops every row (train
...
Results/Results_Tab17_HCPI_EM14.xlsx plus a run_config.json per run.
...
Code/common/config_Tab17_HCPI_EM14.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab17_HCPI_EM14/Tab17_HCPI_EM14.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab17_HCPI_EM14"
EVAL_METRIC_CODE = "EM14"
