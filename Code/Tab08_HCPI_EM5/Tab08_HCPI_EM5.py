"""Tab08_HCPI_EM5 - Headline Consumer Price Index, EM5 (sMAPE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab08_HCPI_EM5", loops every row (train
...
Results/Results_Tab08_HCPI_EM5.xlsx plus a run_config.json per run.
...
Code/common/config_Tab08_HCPI_EM5.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab08_HCPI_EM5/Tab08_HCPI_EM5.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab08_HCPI_EM5"
EVAL_METRIC_CODE = "EM5"
