"""Tab18_HCPI_EM15 - Headline Consumer Price Index, EM15 (TDI) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab18_HCPI_EM15", loops every row (train
...
Results/Results_Tab18_HCPI_EM15.xlsx plus a run_config.json per run.
...
Code/common/config_Tab18_HCPI_EM15.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab18_HCPI_EM15/Tab18_HCPI_EM15.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab18_HCPI_EM15"
EVAL_METRIC_CODE = "EM15"
