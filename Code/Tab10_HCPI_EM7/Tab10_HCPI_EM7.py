"""Tab10_HCPI_EM7 - Headline Consumer Price Index, EM7 (RMSSE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab10_HCPI_EM7", loops every row (train
...
Results/Results_Tab10_HCPI_EM7.xlsx plus a run_config.json per run.
...
Code/common/config_Tab10_HCPI_EM7.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab10_HCPI_EM7/Tab10_HCPI_EM7.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab10_HCPI_EM7"
EVAL_METRIC_CODE = "EM7"
