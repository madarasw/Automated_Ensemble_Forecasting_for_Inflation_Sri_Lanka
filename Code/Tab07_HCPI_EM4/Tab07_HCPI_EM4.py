"""Tab07_HCPI_EM4 - Headline Consumer Price Index, EM4 (MAPE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab07_HCPI_EM4", loops every row (train
...
Results/Results_Tab07_HCPI_EM4.xlsx plus a run_config.json per run.
...
Code/common/config_Tab07_HCPI_EM4.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab07_HCPI_EM4/Tab07_HCPI_EM4.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab07_HCPI_EM4"
EVAL_METRIC_CODE = "EM4"
