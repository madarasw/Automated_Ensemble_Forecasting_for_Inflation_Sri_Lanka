"""Tab16_HCPI_EM13 - Headline Consumer Price Index, EM13 (Soft-DTW) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab16_HCPI_EM13", loops every row (train
...
Results/Results_Tab16_HCPI_EM13.xlsx plus a run_config.json per run.
...
Code/common/config_Tab16_HCPI_EM13.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab16_HCPI_EM13/Tab16_HCPI_EM13.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab16_HCPI_EM13"
EVAL_METRIC_CODE = "EM13"
