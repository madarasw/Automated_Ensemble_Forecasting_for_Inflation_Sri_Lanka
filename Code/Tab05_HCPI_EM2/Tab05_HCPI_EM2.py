"""Tab05_HCPI_EM2 - Headline Consumer Price Index, EM2 (MAE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab05_HCPI_EM2", loops every row (train
...
Results/Results_Tab05_HCPI_EM2.xlsx plus a run_config.json per run.
...
Code/common/config_Tab05_HCPI_EM2.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab05_HCPI_EM2/Tab05_HCPI_EM2.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab05_HCPI_EM2"
EVAL_METRIC_CODE = "EM2"
