"""Tab21_HCPI_EM18 - Headline Consumer Price Index, EM18 (TPA) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab21_HCPI_EM18", loops every row (train
...
Results/Results_Tab21_HCPI_EM18.xlsx plus a run_config.json per run.
...
Code/common/config_Tab21_HCPI_EM18.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab21_HCPI_EM18/Tab21_HCPI_EM18.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab21_HCPI_EM18"
EVAL_METRIC_CODE = "EM18"
