"""Tab13_HCPI_EM10 - Headline Consumer Price Index, EM10 (SQL) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab13_HCPI_EM10", loops every row (train
...
Results/Results_Tab13_HCPI_EM10.xlsx plus a run_config.json per run.
...
Code/common/config_Tab13_HCPI_EM10.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab13_HCPI_EM10/Tab13_HCPI_EM10.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab13_HCPI_EM10"
EVAL_METRIC_CODE = "EM10"
