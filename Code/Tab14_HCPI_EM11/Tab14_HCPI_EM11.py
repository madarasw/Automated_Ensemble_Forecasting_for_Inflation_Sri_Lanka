"""Tab14_HCPI_EM11 - Headline Consumer Price Index, EM11 (MQL) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab14_HCPI_EM11", loops every row (train
...
Results/Results_Tab14_HCPI_EM11.xlsx plus a run_config.json per run.
...
Code/common/config_Tab14_HCPI_EM11.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab14_HCPI_EM11/Tab14_HCPI_EM11.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab14_HCPI_EM11"
EVAL_METRIC_CODE = "EM11"
