"""Tab06_HCPI_EM3 - Headline Consumer Price Index, EM3 (RMSE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab06_HCPI_EM3", loops every row (train
...
Results/Results_Tab06_HCPI_EM3.xlsx plus a run_config.json per run.
...
Code/common/config_Tab06_HCPI_EM3.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab06_HCPI_EM3/Tab06_HCPI_EM3.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab06_HCPI_EM3"
EVAL_METRIC_CODE = "EM3"
