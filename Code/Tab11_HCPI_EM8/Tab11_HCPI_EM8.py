"""Tab11_HCPI_EM8 - Headline Consumer Price Index, EM8 (WAPE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab11_HCPI_EM8", loops every row (train
...
Results/Results_Tab11_HCPI_EM8.xlsx plus a run_config.json per run.
...
Code/common/config_Tab11_HCPI_EM8.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab11_HCPI_EM8/Tab11_HCPI_EM8.py [--exp-id <id>] [--set S1] [--frequency Monthly]
