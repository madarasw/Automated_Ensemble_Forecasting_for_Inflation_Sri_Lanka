"""Tab09_HCPI_EM6 - Headline Consumer Price Index, EM6 (MASE) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab09_HCPI_EM6", loops every row (train
...
Results/Results_Tab09_HCPI_EM6.xlsx plus a run_config.json per run.
...
Code/common/config_Tab09_HCPI_EM6.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab09_HCPI_EM6/Tab09_HCPI_EM6.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab09_HCPI_EM6"
EVAL_METRIC_CODE = "EM6"
