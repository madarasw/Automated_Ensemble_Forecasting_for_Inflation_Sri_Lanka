"""Tab03_CCPI_EM1 - Colombo Consumer Price Index, EM1 (SELECTED (to be determined)) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab03_CCPI_EM1", loops every row (train
...
Results/Results_Tab03_CCPI_EM1.xlsx plus a run_config.json per run.
...
Code/common/config_Tab03_CCPI_EM1.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab03_CCPI_EM1/Tab03_CCPI_EM1.py [--exp-id <id>] [--set S1] [--frequency Monthly]
