"""Tab15_HCPI_EM12 - Headline Consumer Price Index, EM12 (DTW) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab15_HCPI_EM12", loops every row (train
...
Results/Results_Tab15_HCPI_EM12.xlsx plus a run_config.json per run.
...
Code/common/config_Tab15_HCPI_EM12.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab15_HCPI_EM12/Tab15_HCPI_EM12.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab15_HCPI_EM12"
EVAL_METRIC_CODE = "EM12"
