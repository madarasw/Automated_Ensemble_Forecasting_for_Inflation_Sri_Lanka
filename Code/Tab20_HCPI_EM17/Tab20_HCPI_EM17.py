"""Tab20_HCPI_EM17 - Headline Consumer Price Index, EM17 (DA) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab20_HCPI_EM17", loops every row (train
...
Results/Results_Tab20_HCPI_EM17.xlsx plus a run_config.json per run.
...
Code/common/config_Tab20_HCPI_EM17.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab20_HCPI_EM17/Tab20_HCPI_EM17.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab20_HCPI_EM17"
EVAL_METRIC_CODE = "EM17"
