"""Tab12_HCPI_EM9 - Headline Consumer Price Index, EM9 (WQL) as the ensemble-fitting objective.

Reads Code/experiments.csv filtered to tab_name == "Tab12_HCPI_EM9", loops every row (train
...
Results/Results_Tab12_HCPI_EM9.xlsx plus a run_config.json per run.
...
Code/common/config_Tab12_HCPI_EM9.yaml, not hardcoded here - CLI flags override the YAML.

Run: python Code/Tab12_HCPI_EM9/Tab12_HCPI_EM9.py [--exp-id <id>] [--set S1] [--frequency Monthly]
...
TAB_NAME = "Tab12_HCPI_EM9"
EVAL_METRIC_CODE = "EM9"
